...
class ControllerModuleFilterProduct extends Controller {
	public function index($setting) {
		...
		if(isset($setting['more'][$this->config->get('config_language_id')])) {
			...
			if($data['more_text'] == '') $data['more_text'] = '';
		} else {
			$data['more_text'] = '';
		}
		
		if(isset($setting['more2'][$this->config->get('config_language_id')])) {
			$data['more_text2'] = html_entity_decode($setting['more2'][$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');
			if($data['more_text2'] == '') $data['more_text2'] = '';
		} else {
			$data['more_text2'] = '';
		}
		
		if(isset($setting['more3'][$this->config->get('config_language_id')])) {
			$data['more_text3'] = html_entity_decode($setting['more3'][$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');
			if($data['more_text3'] == '') $data['more_text3'] = '';
		} else {
			$data['more_text3'] = '';
		}
