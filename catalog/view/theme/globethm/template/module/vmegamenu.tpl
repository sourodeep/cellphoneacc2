...
<div id="megamenu_<?php echo $id; ?>" class="on-mini container-megamenu <?php if($ustawienia['full_width'] != '1') { echo 'container'; } ?> <?php if($ustawienia['orientation'] == 1) { echo 'vertical'; } else { echo 'horizontal'; } if($ustawienia['display_on_mobile'] == 1) { echo ' mobile-disabled'; } ?>">
...
<div id="megamenu_<?php echo $id; ?>" class="off-mini megamenu_container <?php if($ustawienia['full_width'] != '1') { echo 'container'; } ?> <?php if($ustawienia['orientation'] == 1) { echo 'vertical'; } else { echo 'horizontal'; } if($ustawienia['display_on_mobile'] == 1) { echo ' mobile-disabled'; } ?>">

	<?php if($ustawienia['orientation'] == 1) { ?>
    
    <ul class="megamenu">
    
    <li class="top_level"><span><?php echo $navigation_text; ?></span>
	...
	<div class="">
		<div class="megamenu-pattern">
			<div class="container">
				<ul class="megamenu_main megamenu <?php if($ustawienia['animation'] != '') { echo $ustawienia['animation']; } ?>">
					<?php
						foreach($menu as $row) {
							$class = '';
							$class_link = 'clearfix';
