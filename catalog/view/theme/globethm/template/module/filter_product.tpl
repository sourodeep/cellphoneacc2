...
<div class="filter-product">
    ...
    <div class="category-main-tabs"><a href="<?php echo $more_text2; ?>"><?php echo $more_text; ?></a> <span class="category-main-tabs-small"><a href="<?php echo $more_text2; ?>"> <?php echo $more_text3; ?></a></span></div>
...
<div class="box clearfix box-with-products <?php if($carousel != '0') { echo 'with-scroll';  } ?>">
  <?php if($carousel != 0) { ?>
  <!-- Carousel nav -->
  <a style="margin: 27px 0px 0px 5px !important;" class="next" href="#myCarousel<?php echo $id; ?>" id="myCarousel<?php echo $id; ?>_next"><span></span></a>
  <a style="margin: 27px 0px 0px 15px !important;" class="prev" href="#myCarousel<?php echo $id; ?>" id="myCarousel<?php echo $id; ?>_prev"><span></span></a>
