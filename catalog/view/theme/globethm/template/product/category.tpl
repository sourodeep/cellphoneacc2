...
if(isset($mfilter_json)) {
	if(!empty($mfilter_json)) { 
		echo '<div id="mfilter-json" style="display:none">' . $mfilter_json . '</div>'; 
	} 
}
...
<div id="mfilter-content-container">
  ...
  <div class="category-info clearfix">
    <?php if ($thumb) { ?>
    <div class="image"><img blah src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" /></div>
    <?php } ?>
    <?php if ($description) { ?>
  	...
  	<div><div class="product-list-overflow">
  		<div class="row">
  			<div class="image col-sm-3">
  				...
  				<a href="<?php echo $product['href']; ?>"><img height =100 src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a>
  				<?php } else { ?>
  			...
  			<div class="actions col-sm-3">
  				<div>
  					...
  					<ul>
  						<li><a onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><?php echo $button_wishlist; ?></a></li>
  						<li><a onclick="compare.add('<?php echo $product['product_id']; ?>');"><?php echo $button_compare; ?></a></li>
  					</ul>
  				</div>
  			</div>
  		</div>
