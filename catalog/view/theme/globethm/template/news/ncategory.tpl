...
<?php } ?>
<?php if ($is_category) { ?>
 <?php if ($thumb || strlen($description) > 20) { ?>
  <div class="category-info clearfix">
    <?php if ($thumb) { ?>
...
<?php if ($article) { ?>
	<div class="bnews-list<?php if ($display_style) { ?> bnews-list-2<?php } ?>">
		<?php foreach ($article as $articles) { ?>
			<div class="artblock<?php if ($display_style) { ?> artblock-2<?php } ?> clearfix">
...
<?php if ($is_category) { ?>
  ...
  <div class="content" style="padding-top: 6px"><?php echo $text_empty; ?></div>
  <?php } ?>
<?php } else { ?>
  <?php if (!$article) { ?>
  <div class="content" style="padding-top: 6px"><?php echo $text_empty; ?></div>
