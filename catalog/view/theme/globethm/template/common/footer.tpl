...
if($this->registry->has('theme_options') == true) { 
	...
	<!-- CUSTOM FOOTER
		================================================== -->
	<div class="custom-footer <?php if($theme_options->get( 'custom_footer_layout' ) == 1) { echo 'full-width'; } else { echo 'fixed'; } ?> <?php if($theme_options->get( 'footer_layout' ) != 2 && $theme_options->get( 'custom_footer_layout' ) != 1) { echo 'rounded'; } ?> <?php if($theme_options->get( 'background_status' ) == 1 && $theme_options->get( 'customfooter_background_background' ) == '1' && $theme_options->get( 'customfooter_background_color' ) == '') { echo 'custom-footer-without-background'; } ?>">
						...
						<div class="col-sm-<?php echo $grids; ?>">
							...
							<div class="customfooter-panel-content"><div class="customfooter-panel-overflow">
     							...
     							<div class="twitter-feed">
                                    ...
                                    <div class="tweets clearfix" id="twitterFeed">
                                    </div>
                                    </div>
     							    <script type="text/javascript">
									var config5 = {
  									"id": '<?php echo $customfooter[$language_id]['twitter_widget_id'] ; ?>',
  									"domId": '',
  									"maxTweets": 2,
  									"enableLinks": true,
  									"showUser": false,
