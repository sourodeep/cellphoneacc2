...
<div id="cart_block" class="dropdown">
	<div class="cart-heading dropdown-toogle" data-toggle="dropdown" data-hover="dropdown">
		<i class="cart-icon"></i> 
		<p><?php if($theme_options->get( 'shopping_cart_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'shopping_cart_text', $config->get( 'config_language_id' ) ); } else { echo 'Shopping Cart'; } ?></p>
	...
	<div class="dropdown-menu" id="cart_content"><div id="cart_content_ajax">
		...
		<div class="checkout"><a href="<?php echo $cart; ?>" class="btn btn-default"><?php echo $text_cart; ?></a> &nbsp;<a href="<?php echo $checkout; ?>" class="button"><?php echo $text_checkout; ?></a></div>
		<?php } else { ?>
