...
<!-- MAIN CONTENT
	================================================== -->
<div class="main-content <?php if($theme_options->get( 'content_layout' ) == 1) { echo 'full-width'; } else { echo 'fixed'; } ?> home <?php if($theme_options->get( 'footer_layout' ) != 2 && $theme_options->get( 'custom_footer_layout' ) != 1 && $theme_options->get( 'main_layout' ) != 2) { echo 'rounded'; } ?>">
