                ...
                <div class="col-sm-10">
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
					  ...
					  <!-- Terms Customer Souro -->
					  <div class="form-group">
                        <label class="col-sm-2 control-label" for="paybycheck">Terms Customer</label>
                        <div class="col-sm-10">
                      
						  <select name="paybycheck" id="paybycheck" class="form-control">
                           <option value = 1 <?php if($paybycheck==1)echo "selected='selected'";  ?> > Yes </option>
						   <option value = 0 <?php if($paybycheck==0)echo "selected='selected'";  ?> > No </option>
                          </select>
