        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-4">
			  ...
			  <!-- SOURO -->
			   <div class="form-group">
                <label class="control-label" for="input-order-vendor">Vendor</label>
               
			    <select name="filter_order_vendor" id="input-order-vendor" class="form-control">
                  <option value="*"></option>
				<?php foreach ($vendors as $vendor) { ?>
                  <?php if ($vendor== $order['Vendor']) { ?>
                  <option value="<?php echo $vendor; ?>" selected="selected"><?php echo $vendor; ?></option>
                  <?php } else { ?>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
				...
				<td class="text-left"><?php echo $order['Vendor']; ?></td>
