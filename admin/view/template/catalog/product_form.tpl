			...
			<!-- HOT for="input-image"-->
                ...
                <div class="col-sm-10">
                 <select name="Vendor" id="Vendor" class="form-control">
				   <option value="" <?php if(empty($Vendor))echo "selected='selected'";  ?> >Not Defined</option>
				  <option value="Cesium" <?php if(strcmp($Vendor,"Cesium")==0)echo "selected='selected'";  ?> >Cesium</option>
					<option value="WW"  <?php  if(strcmp($Vendor,"WW")==0)echo "selected='selected'";  ?>>Wireless Warehouse</option> 
