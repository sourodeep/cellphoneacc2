           ...
           <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <iframe width="100%" height="321" src="https://www.youtube.com/embed/4dH7Fgt5auA?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
              </div>
...
function addModule() {	
	...
	<?php foreach ($languages as $language) { ?>
		$('#html-' + module_row + '-<?php echo $language['language_id']; ?>, #block-content-' + module_row + '-<?php echo $language['language_id']; ?>').summernote({
			height: 300
		});
	<?php } ?>
