						...
						<div class="tab-content" id="tab-slide-<?php echo $module_row; ?>">
							...
							<div id="tab_slider_<?php echo $module_row; ?>_language_<?php echo $language_id; ?>" class="tab-content3">
										...
										<div class="input clearfix">
											...
											<select name="slider[<?php echo $module_row; ?>][<?php echo $language_id; ?>][transition_effect]" style="width:362px">
										...
										<div class="input clearfix">
											...
											<input type="text" name="slider[<?php echo $module_row; ?>][<?php echo $language_id; ?>][link]" value="<?php echo $slider[$language_id]['link']; ?>" style="width:362px" />
											<?php } else { ?>
										...
										<?php if(isset($slider[$language_id]['elements'])) { ?>
											...
											<div id="slider-<?php echo $module_row; ?>-<?php echo $language_id; ?>-element-<?php echo $i; ?>" style="padding-top:20px">
												...
												<div class="input clearfix element_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image" <?php if($element['element_type'] != 'image') { echo 'style="display: none"'; } ?>>
													...
													<div class="image" style="width: 424px; float: right">
												...
												<div class="input clearfix element_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image" <?php if($element['element_type'] != 'image') { echo 'style="display: none"'; } ?>>
													...
													<?php if(isset($element['image_url_new_tab'])) { ?>
														<?php if($element['image_url_new_tab'] == 1) { echo '<div class="status status-on" title="1" rel="slider_'.$module_row.'_'.$language_id.'_element_'.$i.'_image_url_new_tab" style="float: right;margin-right: 360px;position: relative"></div>'; } else { echo '<div class="status status-off" title="0" rel="slider_'.$module_row.'_'.$language_id.'_element_'.$i.'_image_url_new_tab" style="float: right;margin-right: 360px;position: relative"></div>'; } ?>
													...
													<?php } else { ?>
														<?php echo '<div class="status status-off" title="0" rel="slider_'.$module_row.'_'.$language_id.'_element_'.$i.'_image_url_new_tab" style="float: right;margin-right: 360px;position: relative"></div>'; ?>
...
function addSlide() {
	...
	html += '			<select name="slider['+ module_row +'][<?php echo $language['language_id']; ?>][transition_effect]" style="width:362px">';
	...
	html += '		<div class="input clearfix">';
	html += '			<p>Link:</p>';
	html += '			<input type="text" name="slider['+ module_row +'][<?php echo $language['language_id']; ?>][link]" value="" style="width:362px">';
	html += '		</div>';
...
function addElement(slider_row, language) {
	...
	html += '		<p>Image</p>';
	html += '		<div class="image" style="width: 424px;float: right">';
	...
	html += '		<div class="status status-off" title="0" rel="slider_' + slider_row + '_' + language + '_element_' + elements + '_image_url_new_tab" style="float: right;margin-right: 360px;position: relative"></div><input name="slider[' + slider_row + '][' + language + '][elements][' + elements + '][image_url_new_tab]" value="0" id="slider_' + slider_row + '_' + language + '_element_' + elements + '_image_url_new_tab" type="hidden" />';
	html += '	</div>';
