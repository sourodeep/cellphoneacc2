           ...
           <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <iframe width="100%" height="321" src="https://www.youtube.com/embed/IIs15fbw6SY?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
              </div>
			...
			<div class="content theme-skins">
				<div>
					<ul class="skins">
						...
						<li>
							<select name="vmegamenu_modules">
								<?php foreach($vmegamenu_modules as $module) { ?>
						...
						<div class="right">
							...
							<div class="input clearfix">
								...
								<select name="position">
									...
									<option value="preface_fullwidth" selected="selected">Menu Vertical</option>
									<?php } else { ?>
									<option value="preface_fullwidth">Menu Vertical</option>
									<?php } ?>
...
$(document).ready(function() {
	...
	function menu_updatesort(jsonstring) {
		...
		if (mittXHRobjekt) {
			...
			ajaxRequest.open("GET", "index.php?route=module/vmegamenu&token=<?php echo $_GET['token']; ?>&module_id=<?php echo $active_module_id; ?>&jsonstring=" + jsonstring, true);
