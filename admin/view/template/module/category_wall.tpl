           ...
           <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <iframe width="100%" height="321" src="https://www.youtube.com/embed/AMXkP7YgSq8?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
              </div>
							...
							<table class="form">
									...
									<td><div class="list-language">
										<?php foreach ($languages as $language) { $lang_id = $language['language_id']; ?>
											<div class="language">
												...
												<input type="text" name="category_wall_module[<?php echo $module_row; ?>][namecat][<?php echo $language['language_id']; ?>]" value="<?php if(isset($module['namecat'][$lang_id])) { echo $module['namecat'][$lang_id]; } ?>" />
											</div>
										<?php } ?>
									</div></td>
								</tr>
                                <tr>
									...
									<td><div class="list-language">
										<?php foreach ($languages as $language) { $lang_id = $language['language_id']; ?>
											<div class="language">
												<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" width="16px" height="11px" />
												<input type="text" name="category_wall_module[<?php echo $module_row; ?>][linkcat][<?php echo $language['language_id']; ?>]" value="<?php if(isset($module['linkcat'][$lang_id])) { echo $module['linkcat'][$lang_id]; } ?>" />
											</div>
										<?php } ?>
									</div></td>
								</tr>
							  ...
							  <tr>
							    ...
							    <td><select name="category_wall_module[<?php echo $module_row; ?>][position]">
							    	...
							    	<option style="display:none" value="preface_fullwidth" selected="selected">Preface fullwidth</option>
							    	<?php } else { ?>
							    	<option style="display:none" value="preface_fullwidth">Preface fullwidth</option>
							    	<?php } ?>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '<h4>Category Images</h4>';
		html += '  <table class="form">';
		html += '	 <tr>';
		html += '		<td>Name Category:</td>';
		...
		html += '				<input type="text" name="category_wall_module[' + module_row + '][namecat][<?php echo $language['language_id']; ?>]" value="" />';
		html += '			</div>';
		<?php } ?>
		html += '		</div></td>';
		html += '	 </tr>';
		html += '	 <tr>';
		html += '		<td>Link Category:</td>';
		html += '		<td><div class="list-language">';
		<?php foreach ($languages as $language) { ?>
		html += '			<div class="language">';
		html += '				<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" width="16px" height="11px" />';
		html += '				<input type="text" name="category_wall_module[' + module_row + '][linkcat][<?php echo $language['language_id']; ?>]" value="" />';
		html += '			</div>';
		<?php } ?>
		html += '		</div></td>';
		html += '	 </tr>';
		...
		html += '					<option value="6" selected="selected">6</option>';
		...
		html += '				<option style="display:none" value="preface_fullwidth">Preface fullwidth</option>';
