           ...
           <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <iframe width="100%" height="321" src="https://www.youtube.com/embed/IeAp_AsFpQA?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
              </div>
				...
				<div>
					<div class="background clearfix">
						...
						<div class="right">
							...
							<div class="input clearfix">
								<p>Submenu width</p>
								<input type="text" name="submenu_width" value="<?php echo $submenu_width; ?>"> <div style="font-size:10px; padding:0; margin:0;">Default: 100% or:<br> 250px; right: auto !important;<br> 350px; right: auto !important; <br>or more...</div>
							</div>
...
\									<?php } else { ?>
							...
							<!-- Input -->
							<div class="input clearfix">
								<p>Enabled <span style="font-size:10px">Pro Mega Menu Vertical</span></p>
								<select name="home_item">
									...
									<option value="text" selected="selected">Enabled</option>
									<?php } else { ?>
									<option value="text">Enabled</option>
									<?php } ?>
							...
							<!-- Input -->
							<!--<div class="input clearfix">
								<p>Class Vertical Menu Active <br /> <span style="font-size:10px">Put here: enabled-menu</span></p>
								<div class="list-language">
								<?php foreach ($languages as $language) { ?>
								<div class="language">
									<?php $language_id = $language['language_id']; ?>
