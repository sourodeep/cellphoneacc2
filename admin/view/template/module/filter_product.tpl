           ...
           <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <iframe width="100%" height="321" src="https://www.youtube.com/embed/IXpdUHi2YnY?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
              </div>
					...
					<div class="tabs clearfix">
						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
                            ...
                            <table class="tabs-list">
								<tr>
									<td>Title Main Category:</td>
									<td class="first">
										<?php foreach ($languages as $language) { $lang_id = $language['language_id']; ?>
											<div class="language">
												<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
												<input type="text" name="filter_product_module[<?php echo $module_row; ?>][more][<?php echo $language['language_id']; ?>]" value="<?php if(isset($module['more'][$lang_id])) { echo $module['more'][$lang_id]; } ?>" />
											</div>
										<?php } ?>
									</td>
								</tr>
                                <tr>
									...
									<td class="first">
										<?php foreach ($languages as $language) { $lang_id = $language['language_id']; ?>
											<div class="language">
												<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
												<input type="text" name="filter_product_module[<?php echo $module_row; ?>][more3][<?php echo $language['language_id']; ?>]" value="<?php if(isset($module['more3'][$lang_id])) { echo $module['more3'][$lang_id]; } ?>" />
											</div>
										<?php } ?>
									</td>
								</tr>
                                <tr>
									<td>Link Main Category And View All:</td>
									<td class="first">
										<?php foreach ($languages as $language) { $lang_id = $language['language_id']; ?>
											<div class="language">
												<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
												<input type="text" name="filter_product_module[<?php echo $module_row; ?>][more2][<?php echo $language['language_id']; ?>]" value="<?php if(isset($module['more2'][$lang_id])) { echo $module['more2'][$lang_id]; } ?>" />
											</div>
										<?php } ?>
									</td>
								</tr>
...
function addModule() {	
	...
	html += '	<div id="tab_filter_product_' + module_row + '_tab" style="padding:20px">';
		...
		html += '	 <tr>';
		html += '		<td>Title Main Category:</td>';
		html += '		<td class="first">';
		<?php foreach ($languages as $language) { ?>
		html += '			<div class="language">';
		html += '				<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />';
		html += '				<input type="text" name="filter_product_module[' + module_row + '][more][<?php echo $language['language_id']; ?>]" value="" />';
		html += '			</div>';
		<?php } ?>
		html += '		</td>';
		html += '	 </tr>';
		html += '	 <tr>';
		html += '		<td>Text View All:</td>';
		html += '		<td class="first">';
		<?php foreach ($languages as $language) { ?>
		html += '			<div class="language">';
		html += '				<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />';
		html += '				<input type="text" name="filter_product_module[' + module_row + '][more3][<?php echo $language['language_id']; ?>]" value="" />';
		html += '			</div>';
		<?php } ?>
		html += '		</td>';
		html += '	 </tr>';
		html += '	 <tr>';
		html += '		<td>Link Main Category And View All:</td>';
		html += '		<td class="first">';
		<?php foreach ($languages as $language) { ?>
		html += '			<div class="language">';
		html += '				<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />';
		html += '				<input type="text" name="filter_product_module[' + module_row + '][more2][<?php echo $language['language_id']; ?>]" value="" />';
		html += '			</div>';
		<?php } ?>
		html += '		</td>';
		html += '	 </tr>';
