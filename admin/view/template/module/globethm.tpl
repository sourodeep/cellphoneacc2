...
<link rel="stylesheet" type="text/css" href="view/stylesheet/globethm.css" />
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo 'index.php?route=module/globethm&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
				...
				<div class="bg-tabs">
					...
					<div id="tab_general" class="tab-content2">
						...
						<div id="tab_translations" class="tab-content">
                            ...
                            <div class="input">
								<p style="width:200px">My space:</p>
								<div class="list-language">
									<?php foreach($languages as $language) { ?>
									<div class="language">
										<?php $language_id = $language['language_id']; ?>
										<img src="../image/flags/<?php echo $language['image'] ?>" alt="<?php echo $language['name']; ?>" width="16px" height="11px" />
										<input type="text" name="my_space[<?php echo $language_id; ?>]" <?php if(isset($my_space[$language_id])) { echo 'value="'.$my_space[$language_id].'"'; } ?>>
									</div>
									<?php } ?>
								</div>
								<div class="clear"></div>
					...
					<div id="tab_design" class="tab-content2">
						...
						<div id="tabs_design" class="htabs tabs-design">
							...
							<a href="#tab_elements" id="tlayout"><span>Elements</span></a>
						...
						<div id="tab_elements" class="tab-content">
						     <!-- Input -->
						     <div class="input">
						     	<p style="width: 270px">Border radius:</p>
						     	<input name="border_radius" type="text" value="<?php if($border_radius == '') { echo '4'; } else { echo $border_radius; } ?>" />
						     	<span style="display: block;float: left;width: auto;padding-top: 5px">px</span>
						     	<div class="clear"></div>
						     </div>
						     <!-- End Input -->
						     ...
						     <div class="input" style="display:none;">
						     	<p style="width:270px">Search in top style:</p>
						     	<select name="search_style">
						     		<option value="0"<?php if($search_style =='0'){echo ' selected="selected"';} ?>>Default</option>
						     		<option value="1"<?php if($search_style =='1'){echo ' selected="selected"';} ?>>Type 2</option>
						     		<option value="2"<?php if($search_style =='2'){echo ' selected="selected"';} ?>>Type 3</option>
						     	</select>
						     	<div class="clear"></div>
						     </div>
						     ...
						     <!-- Input -->
						     <div class="input" style="display:none;">
						     	<p style="width:270px">Menu style:</p>
						     	<select name="menu_style">
						     		<option value="0"<?php if($menu_style =='0'){echo ' selected="selected"';} ?>>Default</option>
						     		<option value="1"<?php if($menu_style =='1'){echo ' selected="selected"';} ?>>Type 2</option>
						     		<option value="2"<?php if($menu_style =='2'){echo ' selected="selected"';} ?>>Type 3</option>
						     	</select>
						     	<div class="clear"></div>
						     </div>
						     ...
						     <!-- Input -->
						     <div class="input" style="display:none;">
						     	<p style="width:270px">Product style:</p>
						     	<select name="product_style">
						     		<option value="0"<?php if($product_style =='0'){echo ' selected="selected"';} ?>>Default</option>
						     		<option value="1"<?php if($product_style =='1'){echo ' selected="selected"';} ?>>Type 2</option>
						     		<option value="2"<?php if($product_style =='2'){echo ' selected="selected"';} ?>>Type 3</option>
						     	</select>
						     	<div class="clear"></div>
						     </div>
						     ...
						     <!-- Input -->
						     <div class="input" style="display:none;">
						     	<p style="width:270px">Button style:</p>
						     	<select name="button_style">
						     		<option value="0"<?php if($button_style =='0'){echo ' selected="selected"';} ?>>Default</option>
						     		<option value="1"<?php if($button_style =='1'){echo ' selected="selected"';} ?>>Type 2</option>
						     		<option value="2"<?php if($button_style =='2'){echo ' selected="selected"';} ?>>Type 3</option>
						     	</select>
						     	<div class="clear"></div>
						     </div>
						     ...
						     <!-- Input -->
						     <div class="input" style="display:none;">
						     	<p style="width:270px">Footer style:</p>
						     	<select name="footer_style">
						     		<option value="0"<?php if($footer_style =='0'){echo ' selected="selected"';} ?>>Default</option>
						     		<option value="1"<?php if($footer_style =='1'){echo ' selected="selected"';} ?>>Type 2</option>
						     	</select>
						     	<div class="clear"></div>
						     </div>
						     ...
						     <!-- Input -->
						     <div class="input">
						     	<p style="width:270px">Box shadow:</p>
						     	<select name="box_shadow">
						     		<option value="0"<?php if($box_shadow =='0'){echo ' selected="selected"';} ?>>enabled</option>
						     		<option value="1"<?php if($box_shadow =='1'){echo ' selected="selected"';} ?>>disabled</option>
						     	</select>
						     	<div class="clear"></div>
						     </div>
						</div>
						...
						<div id="tab_font" class="tab-content">
							...
							<div class="input">
								...
								<select name="categories_bar_px" style="width:80px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($categories_bar_px==$x || ($x == 15 && $categories_bar_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
								
								</select>
								
								<select name="categories_bar_transform" style="width:180px">
								
								  <option value="0" <?php if($categories_bar_transform == 0){echo ' selected="selected"';} ?>>Text-transform: none</option>
								  <option value="1" <?php if($categories_bar_transform == 1){echo ' selected="selected"';} ?>>Text-transform: uppercase</option>
							...
							<div class="input">
								...
								<select name="product_name_weight" style="width:60px;margin-right:20px">
									...
									<?php for( $x = 3; $x <= 8; $x++ ) { ?>
								  <option value="<?php echo $x; ?>" <?php if($product_name_weight==$x || ($x == 6 && $product_name_weight < 3)){echo ' selected="selected"';} ?>><?php echo $x*100; ?></option>
									<?php } ?>
								
								</select>
								<p style="width:54px">Big</p>
								<select name="product_name_big_px" style="width:80px">
								
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($product_name_big_px==$x || ($x == 18 && $product_name_big_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
								
								</select>
								
								<p style="width:81px">Medium</p>
								<select name="product_name_medium_px" style="width:80px;margin-right:0px">
								
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
							<option value="<?php echo $x; ?>" <?php if($product_name_medium_px==$x || ($x == 15 && $product_name_medium_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
							...
							<div class="input">
								...
								<select name="custom_price_weight" style="width:60px;margin-right:20px">
									...
									<?php for( $x = 3; $x <= 8; $x++ ) { ?>
								  <option value="<?php echo $x; ?>" <?php if($custom_price_weight==$x || ($x == 3 && $custom_price_weight < 3)){echo ' selected="selected"';} ?>><?php echo $x*100; ?></option>
									<?php } ?>
								...
								<select name="custom_price_px" style="width:80px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($custom_price_px==$x || ($x == 26 && $custom_price_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
								...
								<select name="custom_price_px_medium" style="width:80px;margin-right:0px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($custom_price_px_medium==$x || ($x == 26 && $custom_price_px_medium < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
								...
								<select name="custom_price_px_small" style="width:80px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($custom_price_px_small==$x || ($x == 19 && $custom_price_px_small < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
								...
								<select name="custom_price_px_old_price" style="width:80px;margin-right:0px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($custom_price_px_old_price==$x || ($x == 16 && $custom_price_px_old_price < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
							...
							<div class="input">
								...
								<p>Headlines in columns:</p>
								<select name="headlines_in_columns">

								<?php foreach (get_fonts() as $key => $font) { 
										
								
									if ($headlines_in_columns == $font) {
										$selected = "selected";
									} else {
									  $selected = "";
									}
								...
								<select name="headlines_in_columns_weight" style="width:60px;margin-right:20px">
								
									<?php for( $x = 3; $x <= 8; $x++ ) { ?>
								  <option value="<?php echo $x; ?>" <?php if($headlines_in_columns_weight==$x || ($x == 4 && $headlines_in_columns_weight < 3)){echo ' selected="selected"';} ?>><?php echo $x*100; ?></option>
									<?php } ?>
								
								</select>
								
								<select name="headlines_in_columns_px" style="width:80px">
								
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($headlines_in_columns_px==$x || ($x == 15 && $headlines_in_columns_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
								
								</select>
								
								<select name="headlines_in_columns_transform" style="width:180px">
								
								  <option value="0" <?php if($headlines_in_columns_transform == 0){echo ' selected="selected"';} ?>>Text-transform: none</option>
								  <option value="1" <?php if($headlines_in_columns_transform == 1){echo ' selected="selected"';} ?>>Text-transform: uppercase</option>
							...
							<div class="input">
								...
								<select name="footer_headlines_weight" style="width:60px;margin-right:20px">
									...
									<?php for( $x = 3; $x <= 8; $x++ ) { ?>
								  <option value="<?php echo $x; ?>" <?php if($footer_headlines_weight==$x || ($x == 6 && $footer_headlines_weight < 3)){echo ' selected="selected"';} ?>><?php echo $x*100; ?></option>
									<?php } ?>
								...
								<select name="footer_headlines_px" style="width:80px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($footer_headlines_px==$x || ($x == 15 && $footer_headlines_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
							...
							<div class="input">
								...
								<select name="page_name_px" style="width:80px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($page_name_px==$x || ($x == 22 && $page_name_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
							...
							<select name="button_font_weight" style="width:60px;margin-right:20px">
							  ...
							  <option value="<?php echo $x; ?>" <?php if($button_font_weight==$x || ($x == 6 && $button_font_weight < 3)){echo ' selected="selected"';} ?>><?php echo $x*100; ?></option>
								...
								<select name="button_font_px" style="width:80px">
									...
									<?php for( $x = 9; $x <= 50; $x++ ) { ?>
					              <option value="<?php echo $x; ?>" <?php if($button_font_px==$x || ($x == 13 && $button_font_px < 6)){echo ' selected="selected"';} ?>><?php echo $x; ?> px</option>
									<?php } ?>
								
								</select>
								
								
								<select name="button_transform" style="width:180px">
								
								  <option value="0" <?php if($button_transform == 0){echo ' selected="selected"';} ?>>Text-transform: none</option>
								  <option value="1" <?php if($button_transform == 1){echo ' selected="selected"';} ?>>Text-transform: uppercase</option>
					...
					<!--<div id="tab_install_data" class="tab-content">
						...
						<div class="input">
							<p style="width:340px">Custom module (banners, customfooter):</p>
						...
						<div class="input">
							<p style="width:340px">Custom module (banners, customfooter type 2):</p>
							<input type="submit" name="install_custom_module2" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">
							
							<div class="clear"></div>
						</div>
						
						<div class="input">
							<p style="width:340px">Custom module (banners, customfooter type 3):</p>
							<input type="submit" name="install_custom_module3" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">
							
							<div class="clear"></div>
						</div>
						
						<div class="input">
							<p style="width:340px">Custom module (banners, customfooter type 4):</p>
							<input type="submit" name="install_custom_module4" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">
							
							<div class="clear"></div>
						</div>
						
						<div class="input">
							<p style="width:340px">Custom module (banners, customfooter type 5):</p>
							<input type="submit" name="install_custom_module5" class="button-install" onclick="return confirm('Are you sure you want to install sample data?')" value="">
							
							<div class="clear"></div>
						</div>
						
						<div class="input">
							<p style="width:340px">Camera slider:</p>
						...
						<div class="input">
							<p style="width:340px">MegaMenu:</p>
