						...
						<div class="tab-content2">
							...
							<div id="newsletter_module_<?php echo $i; ?>" style="padding-top:20px">
								...
								<div id="tab_language_<?php echo $i; ?>_<?php echo $language['language_id']; ?>">
									...
									<div class="input clearfix">
										<p>Module Text:</p>
										<div><textarea rows="0" cols="0" id="newsletter_module_<?php echo $i; ?>_<?php echo $language['language_id']; ?>_html" name="newsletter_module[<?php echo $i; ?>][<?php echo $language['language_id']; ?>][module_text]"><?php echo isset($module[$language['language_id']]['module_text']) ? $module[$language['language_id']]['module_text'] : ''; ?></textarea></div>
									</div>
								...
								<script type="text/javascript">
									...
									<?php foreach ($languages as $language) { ?>
										$('#newsletter_module_<?php echo $i; ?>_<?php echo $language['language_id']; ?>_html').summernote({
											height: 300
										});
									<?php } ?>
								</script>
							...
							<script type="text/javascript">
								...
								function addModule() {
									...
									html += '			<div><textarea rows="0" cols="0" id="newsletter_module_' + module + '_<?php echo $language['language_id']; ?>_html" name="newsletter_module[' + module + '][<?php echo $language['language_id']; ?>][module_text]"></textarea></div>';
									html += '		</div>';
									...
									<?php foreach ($languages as $language) { ?>
										$('#newsletter_module_' + module + '_<?php echo $language['language_id']; ?>_html').summernote({
											height: 300
										});
									<?php } ?>
