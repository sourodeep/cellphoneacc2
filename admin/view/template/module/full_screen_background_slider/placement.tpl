           ...
           <div class="modal-content">
             <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <iframe width="100%" height="321" src="https://www.youtube.com/embed/JMtCfSxKAqU?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
              </div>
					...
					<div class="bg-tabs clearfix">
						...
						<div class="tab-content2">
							...
							function addModule() {
								...
								html += '			    <option style="display:none" value="breadcrumb_top">Breadcrumb top</option>';
								html += '				<option style="display:none" value="breadcrumb_bottom">Breadcrumb bottom</option>';
