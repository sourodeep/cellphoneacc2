...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {  //AHA
		if (isset($this->request->get['filter_order_id'])) {
	...
	//	 SOURO	filter_order_vendor
		...
		$filter_data = array(
			...
			'filter_order_vendor'  =>  $filter_order_vendor, 	//SOURO
		...
		$data['entry_order_vendor'] = $this->language->get('entry_order_vendor');
		...
		$data['vendors']=["Cesium","WW","Composite"];
