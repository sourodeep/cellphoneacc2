...
class ControllerSaleCustomer extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->get['paybycheck'])) {
				$url .= '&paybycheck=' . $this->request->get['paybycheck'];
			}
	...
	protected function getForm() {
		...
		$data['entry_paybycheck'] = $this->language->get('entry_paybycheck');
...
//SOURO
		if (isset($this->request->get['paybycheck'])) {
			$data['paybycheck'] = $this->request->get['paybycheck'];
		} 
		 elseif (!empty($customer_info)) {
			$data['paybycheck'] = $customer_info['paybycheck'];
		} else {
			$data['paybycheck'] = '0';
		}
		//Endoff
